...
<div className='flex flex-col gap-1 xl:w-[45%] lg:w-[45%] md:w-[70%] '>
  {timelime.map((element, index) => {
    return (
      ...
      <div className='flex flex-col  relative shadow-richblue-400 shadow-[1px_1px_30px_7px]'> 
          <img src={timelineimage} alt='timelineimage' className='shadow-white object-cover h-fit'/>
          <div className='shadow-blue'></div>

          <div className='absolute yearportion bg-caribbeangreen-700 flex flex-row :flex-col-reverse text-white uppercase xl:py-7 lg:py-7 md:py-7 sm:py-7 py-5 translate-x-[-50%] tanslate-y-[10%] lg:top-[25rem] xl:top-[25rem] md:top-[30rem] sm:top-[30rem] top-[23rem] left-[50%]  shadow-blue-50 shadow-[5px_5px_13px_5px]'>
