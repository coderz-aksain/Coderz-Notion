    ...
    <div className='flex flex-col    max-w-maxContent text-white justify-center items-center mt-48 mx-auto w-11/12'>
        {/* section 1 */}
            <h1 className='lg:text-4xl xl:text-4xl md:text-4xl sm:text-4xl text-xl font-semibold w-[60%] text-center '>
                ...
                <p className='text-richblack-300  font-medium text-[16px] w-[65%] text-center mt-5'>Coderz-Notion    is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.</p>
        ...
        <HighlightText text={" Our Founding Story  "} />
            ...
            {/* vision and mission wala parent div */}
                ...
                {/* left box */}
                <div className='flex flex-col gap-5'>
                    <h1 className='story1 font-semibold text-3xl'>
