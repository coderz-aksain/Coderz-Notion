...
const Contact = () => {
  return (
    ...
    <div className=' flex lg:flex-row xl:flex-row flex-col xl:mt-0 lg:mt-0 mt-96 gap-5 justify-center items-center mx-auto w-11/12 mb-24 max-w-maxContent'>
        <div className='  shadow-[1px_1px_30px_7px] shadow-richblue-400  flex flex-col bg-richblack-800 px-10 gap-y-6 py-10 mt-[-22rem] rounded-lg'>
            <div className='flex flex-row gap-4 '>
                <BsFillChatLeftDotsFill className='text-4xl text-[#6edffb] bg-richblack-800'/>
                <div className='flex flex-col'>
                    <h1 className='text-2xl text-white font-semibold'>Mail on us</h1>
                    <p  className='text-richblack-300 font-medium'>Our friendly team is here to help.</p>
                    <a   className='text-richblack-300 font-medium' href="mailto:studyhub436@gmail.com">@ayushnikhil2002@gmail.com</a>
                </div>
            </div>
            <div className='flex flex-row gap-4'>
                ...
                <div className='flex flex-col'>
                    ...
                    <p  className='text-richblack-300 font-medium'>HARIDWAR, Utrakhand India</p>
                </div>
            </div>
            <div className='flex flex-row gap-4'>
                ...
                <div className='flex flex-col'>
                    ...
                    <a  className='text-richblack-300 font-medium' href="tel:+123 456 7890">+918126142095</a>
                </div>
            </div>
            
        </div>
        <div className='shadow-[1px_1px_30px_7px] shadow-richblack-300 flex flex-col mx-auto gap-4 bg-richblack-800 mt-16 justify-center items-center px-[-2rem] border-richblack-25 rounded-lg py-12  border'>
